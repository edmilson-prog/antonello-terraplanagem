...
export const apontamentos: Apontamento[] = [
  ...
  // Histórico Jan–Mai/2026 (PRD-016) — 1 apontamento finalizado por OS
  // histórica, horímetro crescente mês a mês e sempre abaixo do menor valor
  // já usado em junho para o mesmo equipamento (eq-001: 8500; eq-002: 5102).
  {
    id: "ap-h01a",
    equipamento_id: "eq-001",
    operador_id: "op-001",
    os_id: "os-h01a",
    horimetro_inicial: 8302,
    horimetro_final: 8312,
    horas_trabalhadas: 10,
    foto_inicial_url: null,
    foto_final_url: null,
    observacao: null,
    ...
    status: "finalizado",
    pendente_sync: false,
    iniciado_em: "2026-01-20T07:00:00.000Z",
    finalizado_em: "2026-01-20T17:00:00.000Z",
    created_at: "2026-01-20T07:00:00.000Z",
    updated_at: "2026-01-20T17:00:00.000Z",
  },
  {
    id: "ap-h01b",
    equipamento_id: "eq-002",
    operador_id: "op-001",
    os_id: "os-h01b",
    horimetro_inicial: 4979,
    horimetro_final: 4987,
    horas_trabalhadas: 8,
    foto_inicial_url: null,
    foto_final_url: null,
    observacao: null,
  ...
  },
  {
    ...
    operador_id: "op-001",
    os_id: "os-h02a",
    horimetro_inicial: 8326,
    horimetro_final: 8340,
    horas_trabalhadas: 14,
    foto_inicial_url: null,
    foto_final_url: null,
    observacao: null,
    modalidade: "operada",
    ...
    status: "finalizado",
    pendente_sync: false,
    iniciado_em: "2026-02-20T07:00:00.000Z",
    finalizado_em: "2026-02-20T17:00:00.000Z",
    created_at: "2026-02-20T07:00:00.000Z",
    updated_at: "2026-02-20T17:00:00.000Z",
  },
  {
    id: "ap-h02b",
    equipamento_id: "eq-002",
    operador_id: "op-001",
    os_id: "os-h02b",
    horimetro_inicial: 5001,
    horimetro_final: 5013,
    horas_trabalhadas: 12,
    foto_inicial_url: null,
    foto_final_url: null,
    observacao: null,
  ...
  },
  {
    ...
    operador_id: "op-001",
    os_id: "os-h03a",
    horimetro_inicial: 8354,
    horimetro_final: 8365,
    ...
    status: "finalizado",
    pendente_sync: false,
    iniciado_em: "2026-03-20T07:00:00.000Z",
    finalizado_em: "2026-03-20T17:00:00.000Z",
    created_at: "2026-03-20T07:00:00.000Z",
    updated_at: "2026-03-20T17:00:00.000Z",
  },
  {
    id: "ap-h03b",
    equipamento_id: "eq-002",
    operador_id: "op-001",
    os_id: "os-h03b",
    horimetro_inicial: 5027,
    horimetro_final: 5036,
    horas_trabalhadas: 9,
    foto_inicial_url: null,
    foto_final_url: null,
    observacao: null,
  ...
  },
  {
    ...
    operador_id: "op-001",
    os_id: "os-h04a",
    horimetro_inicial: 8379,
    horimetro_final: 8395,
    ...
    status: "finalizado",
    pendente_sync: false,
    iniciado_em: "2026-04-20T07:00:00.000Z",
    finalizado_em: "2026-04-20T17:00:00.000Z",
  ...
  },
  {
    ...
    operador_id: "op-001",
    os_id: "os-h04b",
    horimetro_inicial: 5050,
    horimetro_final: 5065,
  ...
  },
  {
    ...
    operador_id: "op-001",
    os_id: "os-h05a",
    horimetro_inicial: 8407,
    horimetro_final: 8420,
    ...
    status: "finalizado",
    pendente_sync: false,
    iniciado_em: "2026-05-20T07:00:00.000Z",
    finalizado_em: "2026-05-20T17:00:00.000Z",
  ...
  },
  {
    ...
    operador_id: "op-001",
    os_id: "os-h05b",
    horimetro_inicial: 5079,
    horimetro_final: 5090,
    horas_trabalhadas: 11,
    foto_inicial_url: null,
    foto_final_url: null,
    observacao: null,
