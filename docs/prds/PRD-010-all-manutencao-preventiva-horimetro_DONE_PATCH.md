...
>
> **Delta:** Correção documental: o alerta interno de manutenção **não** é o PRD-009 (que avisa o **cliente**) — é automação futura própria, agora prevista no INDEX.
>
> **Ação no código:** **Nenhuma** (docs only).
>
...
| Serviço | Tipo | Status |
|---------|------|--------|
| Nenhum (nesta fase) | — | Notificação **interna** de alerta (push/WhatsApp p/ retaguarda) é automação futura própria — **não** confundir com o PRD-009, que avisa o **cliente** |
