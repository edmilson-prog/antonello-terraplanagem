...
| Status | Quantidade |
|--------|------------|
| ✅ Refatorado (bate com o design system) | 28 / 38 |
...
| 13 | Idem — lida do `DesignSync`, sem Artifact | Parâmetros + Configurações (par de telas, linhas 33–34). Primeira onda que criou schema em vez de só re-vestir: tabela `parametros` (singleton) + `parametros_historico` com trigger de versão e histórico | branch `worktree-configuracoes-parametros-designsync`, v0.27.0 "Levers" |
