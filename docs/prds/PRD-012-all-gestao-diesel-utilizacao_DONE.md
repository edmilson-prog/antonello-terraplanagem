...
- **RF-003 (Must):** O operador pode registrar abastecimento (litros/horímetro), **sem qualquer valor**.
...
| **Versão do App** | 0.10.0 (Fuel) |
| **Implementado por** | Claude Code via SDD |
| **Observações** | Frontend First (mockado). Indicadores (consumo médio, utilização) são derivados em memória, nunca persistidos. Custo do diesel é retaguarda-only; litros/horímetro podem aparecer nos dois ambientes. |
...
| 2026-07-02 | v2 | Implementado — 0.10.0 (Fuel) |
