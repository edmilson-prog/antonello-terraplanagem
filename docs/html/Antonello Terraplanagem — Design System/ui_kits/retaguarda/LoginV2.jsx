...
function LoginV2({ onLogin }) {
  ...
  return (
    <div className="rtg-login rtg-login2" data-screen-label="Login v2">
      {/* PAINEL DA MARCA — logo real full-bleed */}
      <aside className="rtg-login2-brand">
        <img src={(window.__resources && window.__resources.logoDark) || '../../assets/logo-antonello-dark.png'} alt="Antonello Terraplanagem" />
        <div className="rtg-login2-scrim"></div>
        <div className="rtg-login2-brandfoot">
      ...
      <main className="rtg-login-main">
        <form className="rtg-login-card" onSubmit={submit} noValidate>
          {/* marca compacta no topo do formulário (aparece quando o painel some no mobile) */}
          <div className="rtg-login2-mark">
            <div className="rtg-logo" style={{ width: 42, height: 42, borderRadius: 12 }}>
              <svg viewBox="0 0 24 24" fill="none" stroke="#16140f" strokeWidth="2.1" strokeLinecap="round" strokeLinejoin="round" style={{ width: 26, height: 26 }}>
                <path d="M3 20h18" /><path d="M6 20v-4h4v4" /><path d="m10 16 3-7 5 4v3" />
              </svg>
            </div>
            <div className="rtg-brand-name" style={{ fontSize: 15 }}>ANTONELLO<small>TERRAPLANAGEM</small></div>
          </div>
