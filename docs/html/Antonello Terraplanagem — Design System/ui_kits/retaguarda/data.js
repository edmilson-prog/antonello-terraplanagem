...
window.RTG = {
  ...
  osDetalhe: { n: 'OS-021', t: 'Terraplenagem — lote industrial', cli: 'Construtora Vale Verde', op: 'Adelar Machado', eq: 'Escavadeira CAT 320', eqIcon: 'truck', h: '62 h', per: 'desde 01/07', v: 'R$ 24.800', st: 'Em andamento', tone: 'amber' },
  /* Orçamento em destaque (usado por screen-orcamento-detalhe.html) */
  orcDetalhe: { n: 'ORC-055', t: 'Terraplenagem — fase 2', cli: 'Construtora Vale Verde', data: '02/07', val: '01/08', v: 'R$ 58.000', st: 'Aberto', tone: 'info' },
  clientes: [
    {
