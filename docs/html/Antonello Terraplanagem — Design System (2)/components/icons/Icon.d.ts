...
export type IconName =
  ...
  | 'sparkles' | 'sun' | 'moon' | 'cloud' | 'cloud-rain' | 'chevron-right' | 'arrow-left' | 'arrow-up-right' | 'pencil'
  | 'message-circle' | 'ban' | 'check' | 'circle-check-big' | 'circle-alert' | 'info'
  | 'lock' | 'eye' | 'eye-off' | 'log-in' | 'history' | 'bell' | 'sliders' | 'building-2' | 'badge-check' | 'briefcase' | 'contact'
