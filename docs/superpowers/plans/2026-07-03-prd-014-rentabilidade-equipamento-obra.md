...
4. Fechamento do PRD:
   ...
   - Tentar `graphify . --update` (pode falhar de novo por falta de chave de API de LLM no ambiente — se falhar, reportar ao usuário como limitação de ambiente, não tentar contornar).
