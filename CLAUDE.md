...
> O PRD diz _o que_ construir; este arquivo diz _como_. Não repita convenções nos PRDs — apenas siga este arquivo.
...
| **Backend**     | Supabase (PostgreSQL) — _aguardando aprovação_                                                                                 |
| **Automação**   | n8n — notificação WhatsApp ao cliente, automações de cobrança _(Onda 2+)_                                                      |
| **Deploy**      | Vercel                                                                                                                         |
